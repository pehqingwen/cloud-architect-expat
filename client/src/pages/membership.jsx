...
if (!API_BASE) {
  throw new Error(
    "VITE_API_URL is not defined. Set it via client/.env* or compose build args and rebuild the client."
  );
}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!presignRes.ok) {
        ...
        throw new Error(`Failed to get upload URL (${presignRes.status}): ${txt || "no body"}`);
      }
